...
parent=File.dirname(node['postgresql']['config']['data_directory']);  

execute 'copy datadir' do
  command 'mkdir -p ' + parent + '; mv /var/lib/postgresql/' + node['postgresql']['version'] + '/main ' + parent
  action :run
